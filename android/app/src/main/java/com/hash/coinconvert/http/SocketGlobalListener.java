...
import com.hash.coinconvert.http.response.GetCurrencyTokensListResponseProcess;
import com.hash.coinconvert.http.response.GetCurrentCurrencyTokensResponseProcess;
import com.hash.coinconvert.http.response.GetSymbolsRateResponseProcess;
