...
public class WheelSurfView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if ( attrs != null ) {
            ...
            try {
                mCenterImgRes = typedArray.getResourceId(R.styleable.wheelSurfView_goImg, 0);
            } finally { //回收这个对象
                typedArray.recycle();
            }
        }
        ...
        if ( mCenterImgRes == 0 ) {
            mStart.setImageResource(R.mipmap.ic_wheel_center);
        } else {
            mStart.setImageResource(mCenterImgRes);
        }
        //给图片设置LayoutParams
        ...
        LayoutParams llPin =
                new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);
        llPin.addRule(RelativeLayout.ALIGN_TOP|RelativeLayout.CENTER_HORIZONTAL);
        ImageView pinView = new ImageView(mContext);
        pinView.setImageResource(R.mipmap.ic_pin);
        pinView.setLayoutParams(llPin);
        addView(pinView);
    ...
    public void setConfig(Builder builder) {
        ...
        if ( builder.mHuanImgRes != 0 )
            mWheelSurfPanView.setmOutCycleImgRes(builder.mHuanImgRes);
    ...
    public static final class Builder {
        ...
        //GO图标
        private Integer mCenterImgRes = 0;
        //圆环的图片引用
        ...
        public final Builder setmCenterImgRes(int mCenterImgRes) {
            this.mCenterImgRes = mCenterImgRes;
            return this;
        }
